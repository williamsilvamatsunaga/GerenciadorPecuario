        ...
        private void btAtualizar_Click(object sender, EventArgs e)
        {
            try
            {
                if (!txtNomeNumeracaoAnimal.Text.Equals("") && !txtRacaAnimal.Text.Equals("") && !cbSexoAnimal.Text.Equals(""))
                {
                    ...
                    MessageBox.Show("Animal atualizado com sucesso!", "Atualizar Animal", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                {
                    MessageBox.Show("Preencha os campos obrigatórios!", "Atualizar Animal", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtNomeNumeracaoAnimal.Clear();
                    txtRacaAnimal.Clear();
                    cbSexoAnimal.SelectedIndex = -1;
                    txtDataNascAnimal.Clear();
            ...
            {
                MessageBox.Show("Erro ao atualizar animal: " + ex.Message, "Atualizar Animal", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
